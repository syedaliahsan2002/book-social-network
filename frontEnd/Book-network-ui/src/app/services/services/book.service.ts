...
import { approvReturnBorrowedBook } from '../fn/book/approv-return-borrowed-book';
import { ApprovReturnBorrowedBook$Params } from '../fn/book/approv-return-borrowed-book';
...
import { findAllBooksbyOwner } from '../fn/book/find-all-booksby-owner';
import { FindAllBooksbyOwner$Params } from '../fn/book/find-all-booksby-owner';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `approvReturnBorrowedBook()` */
  static readonly ApprovReturnBorrowedBookPath = '/books/borrow/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approvReturnBorrowedBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approvReturnBorrowedBook$Response(params: ApprovReturnBorrowedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approvReturnBorrowedBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approvReturnBorrowedBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approvReturnBorrowedBook(params: ApprovReturnBorrowedBook$Params, context?: HttpContext): Observable<number> {
    return this.approvReturnBorrowedBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
  ...
  static readonly FindAllBorrowedBooksPath = '/books/borrewed';
